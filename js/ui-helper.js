(function() {
    ...
    puzzle.uiHelper = {
        ...
        init:function(gridLength) {
            ...
            this.puzzleEl.innerHTML = '<img  alt="Puzzle result" class="Puzzle-placeholder">'
         ...
         */
        createTile: function(coords, tileCounter, URL_Image) {
            ...
            tile.style.backgroundImage = `url('${URL_Image}')`;
        ...
        updateStats: function(time, score) {
            const statsContainers = window.document.querySelectorAll(`.${USER_STATS_CLASS} span`);
        ...
        finishGame: function(score, time, moves, records) {
            ...
            const statsContainers = screen.querySelectorAll('span');
            statsContainers[TIME].innerHTML = this.convertToHms(time);
